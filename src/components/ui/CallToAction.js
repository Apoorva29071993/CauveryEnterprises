...
const useStyles = makeStyles(theme => ({
  ...
  background : {
    ...
    backgroundAttachment : "fixed" ,//For parallex effect
...
export default function CallToAction(props) {
    ...
    return (
            <Grid container alignItems="center" justify={ matchesSM ? "center" : "space-between"} direction={matchesSM ? "column" : "row"} className={classes.background}>
