			...
			<Grid container direction="column" >
				...
				style={{marginTop : matchesXS ? "1em" : "2em"}} className={classes.rowContainer}>
						...
						<Grid item className={classes.arrowContainer} style={{marginRight : "1em" , marginLeft : "-3.5em"}}>
							...
							component={Link} to="/customsoftware" onClick={() => props.setSelectedIndex(1)}>
						...
						<Grid item container direction="column" className={classes.heading}>
							...
							<Grid item>
							  ...
							  <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
								...
								native solutions for any part of your business process. This opens you up to a whole new world of possibilities
				...
				style={{marginTop : "15em" , marginBottom : "15em"}} className={classes.rowContainer}>
					<Grid item container direction="column" md> //md is used so all the items within share same space
						<Grid item >
				...
				//Row 3 Starts here
					...
					style={{ marginBottom : "15em"}} className={classes.rowContainer}>
						...
						<Grid item container style={{marginTop : matchesMD ? "10em" : 0 , marginBottom : matchesMD ? "10em" : 0}}
						 direction="column" alignItems="center" md> 
							<Grid item >
								<Typography align="center" variant="h4" gutterBottom>Extend Access</Typography>	
							</Grid>
							<Grid item >
								<img src={access} alt="access image" style={{maxWidth : matchesXS ? "20em" : "28em"}}/>
							</Grid>
						</Grid>
