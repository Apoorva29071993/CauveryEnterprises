...
export default function Revolution(props) {
			...
			return (
					...
					<Grid container direction="column" >
							...
							<Grid item container direction="column" lg style={{maxWidth : "40em"}}>
								...
								<Grid item >
									...
									<Typography variant="body1" paragraph align={matchesMD ? "center" : "right"}>
										...
										The best way to predict the future is to be the one building it, and we want to help guide the world 
									...
									<Typography variant="body1" paragraph align={matchesMD ? "center" : "right"}>
										We see a future where every individual has personalized software custom tailored to their lifestyle, culture, and interests, 
						...
						//3nd row Technology starts here
							...
							<Grid item container direction="column" lg style={{maxWidth : "40em"}}>
								...
								<Grid item >
									...
									<Typography variant="body1" paragraph align={matchesMD ? "center" : undefined}>
										...
										Instead of having to master two completely separate development platforms, you can leverage 
										the knowledge you already possessed from building websites and reapply it directly! This was a huge leap forward.
									</Typography>
									<Typography variant="body1" paragraph align={matchesMD ? "center" : undefined}>
										This technology is now being used by companies like AirBnB, Microsoft, Netflix, Pinterest, Skype, Tesla, UberEats, and 
										when Facebook purchased Instagram large portions of it were even rebuilt using React.
									</Typography>
									<Typography variant="body1" paragraph align={matchesMD ? "center" : undefined}>
										Developers have since built on top of these systems by automating project setup and deployment, allowing creators to focus
										as much as possible on their work itself.
									</Typography>
									<Typography variant="body1" paragraph align={matchesMD ? "center" : undefined}>
						...
						//5th Consultation row starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#B3B3B3" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Consultation</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Detailed notes will be taken on your requirements and constraints, while taking 
											care to identify other potential areas for consideration.
										</Typography>
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Cutting-edge advancements in machine learning like object detection and natural language processing allow 
											computers to do things previously unimaginable, 
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={consultation} alt="consultation image" style={{maxWidth : 700}} width="100%"/>
								</Grid>
						...
						//6th row starts Mockup here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#FF7373" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>MockUp</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Then it’s time for us to start on your minimum viable product. That’s just a fancy term for a mockup,
											 which doesn’t include colors, images, or 
											any other polished design elements, but captures the essential layout structure and functionality.
										</Typography>
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={mockup} alt="mockup image" style={{maxWidth : 1000}} width="100%" />
								</Grid>

							</Grid>

						//7th row Review starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#39b54A" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Review</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Before moving any farther we come back to you with our progress. This gives you the freedom to
											discuss any changes you may want or any ideas you may have come up with before any heavy lifting has been done.
										</Typography>
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Once you’re completely satisfied with the vision for our solution we get down 
											to the nitty gritty, fine-details of design.
										</Typography>
									</Grid>
								</Grid>

								<Grid item lg style={{alignSelf : "center"}}>
									<img src={review} alt="review image" width="100%"/>
								</Grid>

							</Grid>
						//8th row Design starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#A67C52" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Design</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											Using the mockups and notes taken during the consultation as guides, we will start ironing out what 
											the final product will look like. This also involves using any brand material
											 like fonts, colors, and logos to extend the experience you’re already familiar with.
										</Typography>
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={design} alt="design image" style={{maxWidth : 1000}} width="100%"/>
								</Grid>

							</Grid>
						//9th row Review 2 starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#39B54A" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Review</Typography>
									...
									<Grid item >
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											This time we’ll be going over the finalized designs in another fully interactive demonstration. Again this gives you an opportunity to 
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={review} alt="review 2 image" width="100%" />
								</Grid>

							</Grid>

						//10th row Build starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#FBB03B" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Build</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											 Engineering begins after your approval on the final designs. We start by scaffolding out the project on a high level,
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											 of possibilities.Only after our rigorous examinations will we accept a product as finished,
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={build} alt="build image" style={{maxWidth : matchesMD ? 700 : 1000}} width="100%"/>
								</Grid>

							</Grid>

						//11th row Launch starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#C1272D" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Launch</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											When construction comes to a close you’re the first one to know. We’ll give our final demonstration to show off 
											your shiny new software in the wild so you know exactly how it will look to your users.
										</Typography>
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											When you say the word, we press the button and launch your project out to the public. We’re there to ensure everything goes 
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={launch} alt="launch image" style={{maxWidth : 200}} width="100%" />
								</Grid>

							</Grid>
						//12th row Maintain starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#8E45CE" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Maintain</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
										...
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
											From there on out we make sure your application is kept up to date and taking advantage of the best
											 ...
											 future projects, we will implement those advancements in your project as part of our routine maintenance.
										</Typography>
									</Grid>
								</Grid>

								<Grid item lg style={{alignSelf : "center"}}>
									<img src={maintain} alt="maintain image" style={{maxWidth : 500}} width="100%" />
								</Grid>

							</Grid>
						//13th row Iterate starts here
							<Grid item container direction={matchesMD ? "column" :"row"} className={classes.rowContainer} style={{backgroundColor : "#29ABE2" , height : "90em"}}>
								<Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
									<Grid item >
										<Typography variant="h4" style={{color : "#000" , marginTop : "5em"}} gutterBottom align={matchesMD ? "center" : undefined}>Iterate</Typography>
									</Grid>
									<Grid item >
										<Typography variant="body1" style={{color : "#fff" , maxWidth : "20em"}} paragraph align={matchesMD ? "center" : undefined}>
								...
								<Grid item lg style={{alignSelf : "center"}}>
									<img src={iterate} alt="iterate image" width="100%" />
								</Grid>

							</Grid>

						//14th row Estimate Iterate starts here
						<Grid item >
