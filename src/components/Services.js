	...
	<Grid container direction="column">
		...
		<Grid item>{/*----Services Block ios/Android Start----*/}
            <Grid container direction="row" justify={matchesSM ? "center" : "flex-end"} 
                ...
                <Grid item style={{marginRight : matchesSM ? 0 : "5em"}}>
                    <img className={classes.icon} width="250em" alt="mobile phone icon" src={mobileAppsIcon} />
                </Grid>
            </Grid>
        ...
        <Grid item>{/*----Services Block Websites Start----*/}
            ...
            className={classes.serviceContainer} style={{marginBottom : "10em"}}>
                ...
                <Grid item style={{marginRight : matchesSM ? 0 : "5em"}}>
                    <img className={classes.icon} width="250em" alt="websites icon" src={websitesIcon} />
                </Grid>
            </Grid>
