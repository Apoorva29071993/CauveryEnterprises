...
const useStyles = makeStyles(theme => ({
    //*maxWidth and minWidth is used to restrict animation
      //size when screen size is change   d
    animation : {
      maxWidth : "50em",
      minWidth : "21em",
      marginTop : "2em",
    ...
    revolutionCard : {
        //absolute is used to make sit image on top of the background
      position : "absolute",
...
export default function LandingPage(props) {
    ...
    return (
      <Grid container direction="column" className={classes.mainContainer}>
        ...
        {/*justify is used for horizontal since direction is row
           and alignItems is used for vertical to align items to center*/}
          <Grid container justify="flex-end" alignItems="center" direction="row">
          {/*automatically share space using mentioned sm breakpoint*/}
          <Grid sm item className={classes.heroTextContainer}>
              ...
              <Grid container justify="center" className={classes.buttonContainer}>
                ...
                <Grid item >
                  <Button component={Link} to="/revolution" onClick={() => props.setValue(2)} className={classes.learnButtonHero} variant="outlined">
        ...
        <Grid item>{/*----Services Block CSD Start----*/}
        ...
        </Grid>{/*----Services Block CSD End----*/}

        <Grid item>{/*----Services Block ios/Android Start----*/}
            <Grid container direction="row" justify={matchesSM ? "center" : "flex-end"} className={classes.serviceContainer}>
                <Grid item style={{marginLeft : matchesSM ? 0 : "5em" , textAlign : matchesSM ? "center" : undefined}}>
                    ...
                    <Button component={Link} to="/mobileapps" variant="outlined" onClick={() => {props.setValue(1); props.setSelectedIndex(2)}} className={classes.learnButton}>
                        <span style={{marginRight : 10}}>Learn More</span>
                        <ButtonArrow width={10} height={10} fill={theme.palette.common.blue}/>
                    </Button>
                </Grid>
        ...
        </Grid>{/*----Services Block ios/Android End----*/}

        <Grid item>{/*----Services Block Websites Start----*/}
            <Grid container direction="row" justify={matchesSM ? "center" : undefined} className={classes.serviceContainer}>
                <Grid item style={{marginLeft : matchesSM ? 0 : "5em" , textAlign : matchesSM ? "center" : undefined}}>
                    <Typography variant="h4">
                        Website Development
        ...
        </Grid>{/*----Services Block Websites End----*/}

        <Grid item>{/*----Revolution block start----*/}
                ...
                <CardContent>
                  <Grid container style={{textAlign : "center"}} direction="column">
                    ...
                    <Grid item >
                      ...
                      <Button className={classes.learnButtonHero} component={Link} onClick={() => props.setValue(2)} to="/revolution" variant="outlined">
                      <span style={{marginRight : 10}}>Learn More</span>
                      <ButtonArrow width={"15px"} height={"15px"} fill={theme.palette.common.blue}/>
                      </Button>
                    </Grid>
        ...
        </Grid>{/*----Revolution block end----*/}

        <Grid item>{/*----Information block start----*/}
            <Grid container direction="row" alignItems="center" style={{height : "80em"}} className={classes.infoBackground}>
              ...
              <Grid item container style={{ textAlign : matchesXS ? "center" : "inherit"}}
                 direction={matchesXS ? "column" : "row"} >
                    <Grid item sm style={{ marginLeft : matchesXS ? 0 : matchesSM ? "2em" : "5em"}}>{/*sm is used so the items share space within container*/}
                        ...
                        <Grid item >
                        <Button variant="outlined" component={Link} to="/about" onClick={() => {props.setValue(3)}} className={classes.learnButton} style={{color : "white" , borderColor : "white"}}>
                            <span style={{marginRight : 10}}>Learn More</span>
                    ...
                    <Grid item sm style={{ marginRight : matchesXS ? 0 : matchesSM ? "2em" : "5em" , textAlign : matchesXS ? "center" : "right"}}>
                        ...
                        <Grid item >
                        <Button variant="outlined" component={Link} to="/contact" onClick={() => {props.setValue(4)}} className={classes.learnButton} style={{color : "white" , borderColor : "white"}}>
                            <span style={{marginRight : 10}}>Learn More</span>
                            <ButtonArrow width={10} height={10} fill="white"/>
                        </Button>
                        </Grid>
        ...
        </Grid>{/*----Information block end----*/}

        <Grid item >{/*----CallToAction block start----*/}
          <CallToAction setValue={props.setValue}/>
        </Grid>{/*----CallToAction block end----*/}
      </Grid>
    );
}
