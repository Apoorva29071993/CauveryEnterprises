...
export default function CustomSoftware(props) {
	...
	return (
			//Whole custom page in column start
			...
			//Row 1 Starts here
				...
				style={{marginTop : matchesXS ? "1em" : "2em"}} className={classes.rowContainer}>
						...
						<Grid item container direction="column" className={classes.heading}>
							...
							<Grid item>
							  ...
							  <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
								Using regular commercial software leaves you with a lot of stuff you don’t need, without some of the stuff you do need,
				...
				//Row 4 Start from here
				<Grid item container alignItems={matchesMD ? "center" : undefined} direction={matchesMD ? "column" : "row"} style={{marginTop : "20em" , marginBottom : "20em"}} className={classes.rowContainer}>
				...
				//Row 5 start from here
				<Grid item container alignItems={matchesMD ? "center" : undefined} direction={matchesMD ? "column" : "row"} 
				justify="space-between" style={{marginBottom : "10em"}} className={classes.rowContainer}>
						...
						<Grid item container className={classes.itemContainer} direction={matchesSM ? "column" : "row"} md>
							<Grid item md>
								<Lottie options={uxOptions} style={{maxWidth:280 , maxHeight:260 }}/>
							</Grid>
							<Grid item container direction="column" md>
									<Grid item >
